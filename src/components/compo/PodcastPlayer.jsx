    ...
    <section className="bg-[#f6f4f1] py-[20px] md:py-[2%] px-[20px] md:px-[8%] text-[#2C3E50]">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
          <span className="text-[#E67E22]">Toto Village</span> Podcast
        </h2>
        ...
        >
          {podcastData.map((podcast) => (
            <SwiperSlide key={podcast.id}>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col group border border-transparent hover:border-[#5B8C5A]/20">
                <div className="relative overflow-hidden rounded-lg mb-6">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#2C3E50]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                ...
                <a
                  ...
                  className="mt-auto bg-[#E67E22] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#4a7a48] transition-all duration-300 shadow-md hover:shadow-lg text-center"
                >
                  Play Episode
                </a>
              </div>
          ...
          {/* Custom Navigation */}
          <div className="swiper-button-next !text-[#5B8C5A] after:!text-2xl"></div>
          <div className="swiper-button-prev !text-[#5B8C5A] after:!text-2xl"></div>
          <div className="swiper-pagination !bottom-0 [&>.swiper-pagination-bullet-active]:!bg-[#5B8C5A]"></div>
        </Swiper>
      </div>
    </section>
  );
