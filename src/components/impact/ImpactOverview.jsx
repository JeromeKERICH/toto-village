...
const ImpactHero = () => {
    ...
    return (
        <section className="relative md:h-[400px] h-[450px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a2f3a] via-[#2C3E50] to-[#3a5c40]">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    <motion.div variants={itemVariants}>
                        ...
                        Redefining Early Childhood <span className="block mt-4 bg-gradient-to-r from-[#E67E22] via-[#FFA500] to-[#E67E22] bg-clip-text text-transparent">
