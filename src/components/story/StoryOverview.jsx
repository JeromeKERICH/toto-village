  ...
  return (
    <section className="bg-white py-[20px] md:py-[2%] px-[20px] md:px-[8%] text-[#2C3E50]">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-lg text-[#4a4a4a] leading-relaxed text-start md:text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {/* Inception Card */}
        <div className="bg-[#2C3E50] p-8 rounded-xl shadow-lg hover:shadow-xl transition-all group border border-transparent hover:border-[#5B8C5A]/20">
          
          <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#5B8C5A] transition-colors">
            Inception
          </h3>
